...
export type MainStackParamList = {
    Home: undefined;
    Search: { initialQuery?: string; initialCategory?: string; featured?: boolean };
    MapView: undefined; // Or maybe { initialRegion?: Region }
    ItineraryPlanner: { itineraryId?: string; activity?: Activity }; // Optional ID to load existing itinerary or activity to add
